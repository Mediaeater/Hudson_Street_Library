...
**Format descriptions with paragraph breaks:**
- Descriptions > 500 characters MUST use `<p>` tags with `class="mt-6"` spacing
- Never create single-blob descriptions
- Makes content readable and improves user experience
